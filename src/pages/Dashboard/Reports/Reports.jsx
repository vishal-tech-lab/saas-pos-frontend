  ...
  const reportCategories = [
    {
      ...
      description: "Billing and invoice reports",
      color: "from-blue-500 to-indigo-500",
      icon: <Receipt className="w-8 h-8" />,
      reports: [
        {
          name: "Multiple Bills",
          description: "Bulk billing operations",
          path: "/dashboard/reports/mutiplebill",
          icon: <FileText className="w-5 h-5" />,
          color: "from-blue-500 to-cyan-500"
        },
        {
          name: "Bills",
          description: "Individual bill management",
          path: "/dashboard/bill",
        ...
        },
        {
          ...
          description: "Customer billing history",
          path: "/dashboard/reports/customerrecord",
    ...
    },
    {
      ...
      description: "Stock and sales analytics",
      color: "from-green-500 to-emerald-500",
      icon: <Package className="w-8 h-8" />,
      reports: [
        {
          name: "Item Report",
          description: "Vegetable inventory analysis",
        ...
        },
        {
          ...
          description: "Customer sales overview",
    ...
    },
    {
      ...
      description: "Payment and expense tracking",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-gradient-to-r from-green-300/10 to-emerald-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/3 w-72 h-72 bg-gradient-to-r from-purple-200/10 to-pink-300/10 rounded-full blur-3xl animate-pulse delay-2000"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto">

        {/* ✅ Header — icon + title on same line */}
      {/* ✅ Header — icon + title on same line AND centered */}
<motion.div
...
>
  {/* Wrap Icon and H1 in a row container */}
  <div className="flex items-center justify-center gap-5 mb-2">
    <motion.div
      ...
      className="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-2xl flex-shrink-0"
    >
      <BarChart3 className="w-7 h-7 text-white" />
    </motion.div>

    <h1 className="text-3xl md:text-5xl font-black text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text leading-tight">
      Business Reports
    </h1>
  </div>
  ...
  <p className="text-slate-600 text-sm md:text-base font-medium text-center max-w-2xl">
    Comprehensive analytics and insights for your vegetable wholesale business
  </p>
</motion.div>
        {/* Report Categories */}
        <motion.div
                    ...
                    >
                      <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-sm border border-white/50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                        ...
                        <div>
                          ...
                          <p className="text-slate-600 text-sm font-medium group-hover:text-slate-700 transition-colors duration-300">
                            {report.description}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-200/50">
                          ...
                          <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center gap-2 text-slate-500 hover:text-green-600 transition-colors duration-300"
                          >
