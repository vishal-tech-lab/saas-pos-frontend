...
import {
  Plus, Download, Edit, Users, FileText,
  Receipt, UserPlus, Database, Settings,
  ShoppingCart, ArrowRight, Eye
} from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-600 text-sm md:text-base font-medium text-center max-w-2xl">
            Comprehensive sales and customer management for your vegetable wholesale business
          </p>
        </motion.div>
